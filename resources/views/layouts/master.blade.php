...
<head>
  ...
  <title>PROJECT-34</title>

  <!-- Custom fonts for this template-->
  <link href="{{ asset('BStemplate/vendor/fontawesome-free/css/all.min.css') }}" rel="stylesheet" type="text/css">
...
<body id="page-top">
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Project-34 Website 2020</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
  ...
  <!-- Page level plugins -->
  <script src="{{ asset('BStemplate/vendor/chart.js/Chart.min.js') }}"></script>
